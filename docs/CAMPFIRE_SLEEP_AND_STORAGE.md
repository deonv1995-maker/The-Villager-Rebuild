...
- First-person hammer utility targeting reuses the shared `selectFirstPersonUtilityTarget()` centre-reticle selector already used by Bench and storage interactions. Third-person targeting chooses the nearest utility within the same 2.8-unit interaction reach.
...
- shared first-person reticle targeting with no competing utility raycaster;
