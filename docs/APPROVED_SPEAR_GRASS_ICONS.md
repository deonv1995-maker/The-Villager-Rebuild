...
This is a visual-only asset replacement. Spear behavior, hunting, harvesting, inventory quantities, tool durability, resource renewal, save data and construction behavior are unchanged.
