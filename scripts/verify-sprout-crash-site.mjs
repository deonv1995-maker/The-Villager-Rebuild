...
const checks = [
  ...
  ['documentation keeps production Sprout art and falling-tree damage as later slices while companion retrieval, capacity and physical felling are active', docs.includes('production Sprout 3D asset') && docs.includes('falling-tree damage/collision') && docs.includes('Sprout follows the Ranger') && docs.includes('visible authored-tree fall') && docs.includes('96 compressed units')]
];
