...
const checks = [
  ...
  ['documentation keeps production Sprout art, following and compression as later slices', docs.includes('production Sprout') && docs.includes('follower') && docs.includes('compression')]
];
