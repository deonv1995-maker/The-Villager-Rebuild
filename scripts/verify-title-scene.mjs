...
const checks = [
  ...
  ['Ranger title arms blend toward neutral rest pose', titleScene.includes('TITLE_ARM_BONES') && titleScene.includes('#applyRangerArmRestPose()') && config.includes('rangerArmRestBlendMenu')],
