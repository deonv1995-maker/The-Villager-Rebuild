...
const checks = [
  ...
  ['runtime forwards companion scanning state and selected target into the scanner rendering layer', runtime.includes('ensureSproutScannerVisual') && runtime.includes('updateSproutScannerVisual') && runtime.includes('presentation.scanning') && runtime.includes('presentation.scanTarget') && runtime.includes('target: scanTarget')],
