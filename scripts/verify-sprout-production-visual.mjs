...
const checks = [
  ...
  ['runtime forwards the existing companion scanning state into the scanner rendering layer', runtime.includes('ensureSproutScannerVisual') && runtime.includes('updateSproutScannerVisual') && runtime.includes('presentation.scanning') && runtime.includes('updateSproutScannerVisual(this.visual, this.elapsed, { powered, scanning })')],
  ...
  ['scanner documentation preserves the visual-only boundary and mobile rendering budget', scannerDocs.includes('active presentation effect') && scannerDocs.includes('getPresentationState().scanning') && scannerDocs.includes('presentation-only addition') && scannerDocs.includes('Mobile rendering budget') && scannerDocs.includes('Rendering code must not introduce a second scan radius')],
