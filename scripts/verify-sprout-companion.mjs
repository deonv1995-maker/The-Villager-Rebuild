...
const checks = [
  ...
  ['documentation records the physical mission and repeatable underground scan contracts', docs.includes('2 through 5') && docs.includes('18 m') && docs.includes('10 seconds') && docs.includes('8-second') && docs.includes('every manual scan') && autonomyDocs.includes('physical mission companion')],
