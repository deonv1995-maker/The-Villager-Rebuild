...
const checks = [
  ...
  ['documentation records lens-origin scan lock before reservation/compression', docs.includes("scanning lens") && docs.includes('scan-lock pause') && docs.includes('scanner then turns off before the pickup is reserved')],
