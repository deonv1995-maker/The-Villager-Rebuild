...
const checks = [
  ...
  ['allied Sprout supplies one bounded non-shadow cave navigation light from shared depth', definitions.includes('navigationLight: Object.freeze') && controller.includes("sprout-underground-navigation-light") && controller.includes('castShadow = false') && controller.includes('getUndergroundDepth?.(this.playerPosition)') && controller.includes('undergroundDarknessAtDepth(depth)')],
